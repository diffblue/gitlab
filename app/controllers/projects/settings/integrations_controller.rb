    ...
    class IntegrationsController < Projects::ApplicationController
      ...
      def success_message
        if integration.active?
          s_('Integrations|%{integration} settings saved and active.').format(integration: integration.title)
        else
          s_('Integrations|%{integration} settings saved, but not active.').format(integration: integration.title)
        end
      end
