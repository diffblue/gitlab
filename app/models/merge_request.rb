...
class MergeRequest < ApplicationRecord
  ...
  def has_test_reports?
    actual_head_pipeline&.has_reports?(Ci::JobArtifact.for_report(:test))
  end
  ...
  def has_accessibility_reports?
    actual_head_pipeline.present? && actual_head_pipeline.has_reports?(Ci::JobArtifact.for_report(:accessibility))
  end
  ...
  def has_terraform_reports?
    actual_head_pipeline&.has_reports?(Ci::JobArtifact.for_report(:terraform))
  end
  ...
  def has_codequality_reports?
    actual_head_pipeline&.has_reports?(Ci::JobArtifact.for_report(:codequality))
  end
  ...
  def has_sast_reports?
    !!actual_head_pipeline&.has_reports?(::Ci::JobArtifact.for_report(:sast))
  end

  def has_secret_detection_reports?
    !!actual_head_pipeline&.has_reports?(::Ci::JobArtifact.for_report(:secret_detection))
  end
