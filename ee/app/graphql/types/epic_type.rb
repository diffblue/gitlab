...
module Types
  class EpicType < BaseObject
    ...
    field :start_date_from_inherited_source, Types::TimeType, null: true, authorize: :admin_epic,
    ...
    field :due_date_from_inherited_source, Types::TimeType, null: true, authorize: :admin_epic,
    ...
    field :due_date_is_fixed, GraphQL::Types::Boolean, null: true, method: :due_date_is_fixed?,
      authorize: :admin_epic,
    ...
    field :has_parent, GraphQL::Types::Boolean, null: false, method: :has_parent?,
      description: 'Indicates if the epic has a parent epic.'

    field :web_path, GraphQL::Types::String, null: false, method: :group_epic_path,
      description: 'Web path of the epic.'

    field :web_url, GraphQL::Types::String, null: false, method: :group_epic_url,
      description: 'Web URL of the epic.'

    field :relation_path, GraphQL::Types::String, null: true, method: :group_epic_link_path,
    ...
    field :reference, GraphQL::Types::String, null: false, method: :epic_reference,
    ...
    field :issues, Types::EpicIssueType.connection_type, null: true, complexity: 5,
    ...
    field :blocking_count, GraphQL::Types::Int, null: true, complexity: 5,
    ...
    field :blocked_by_epics, ::Types::EpicType.connection_type, null: true, complexity: 5,
