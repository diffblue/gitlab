...
module Types
  class IterationType < BaseObject
    ...
    field :iid, GraphQL::Types::ID, null: false, description: 'Internal ID of the iteration.'
    ...
    field :state, Types::IterationStateEnum, null: false, description: 'State of the iteration.'
