...
module Types
  ...
  class VulnerableProjectsByGradeType < BaseObject
    ...
    field :grade,
          Types::VulnerabilityGradeEnum,
          null: false,
          description: "Grade based on the highest severity vulnerability present."

    field :count, GraphQL::Types::Int, null: false, complexity: 5,
          description: 'Number of projects within this grade.'

    field :projects, Types::ProjectType.connection_type, null: false, complexity: 5,
