    ...
    module Pipeline
      ...
      def license_scanning_report
        ::Gitlab::Ci::Reports::LicenseScanning::Report.new.tap do |license_scanning_report|
          latest_report_builds(::Ci::JobArtifact.for_report(:license_scanning)).each do |build|
      ...
      def dependency_list_report
        ::Gitlab::Ci::Reports::DependencyList::Report.new.tap do |dependency_list_report|
          latest_report_builds(::Ci::JobArtifact.for_report(:dependency_list)).success.each do |build|
            build.collect_dependency_list_reports!(dependency_list_report)
          end
          latest_report_builds(::Ci::JobArtifact.for_report(:license_scanning)).success.each do |build|
      ...
      def metrics_report
        ::Gitlab::Ci::Reports::Metrics::Report.new.tap do |metrics_report|
          latest_report_builds(::Ci::JobArtifact.for_report(:metrics)).each do |build|
      ...
      def sbom_reports
        ::Gitlab::Ci::Reports::Sbom::Reports.new.tap do |sbom_reports|
          latest_report_builds(::Ci::JobArtifact.for_report(:sbom)).each do |build|
      ...
      def license_scan_completed?
        latest_report_builds(::Ci::JobArtifact.for_report(:license_scanning)).exists?
      end
      ...
      def has_security_reports?
        has_reports?(::Ci::JobArtifact.security_reports.or(::Ci::JobArtifact.for_report(:license_scanning)))
      end

      def has_sbom_reports?
        has_reports?(::Ci::JobArtifact.for_report(:sbom))
      end
