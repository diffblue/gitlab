...
export const SECURITY_CONFIGURATION_CI_CD_STORAGE_KEY = 'security-configuration-ci-cd';
...
export default {
  ...
  SECURITY_CONFIGURATION_CI_CD_STORAGE_KEY,
  components: {
    GlLink,
    GlSprintf,
    GlButton,
...
<template>
  <gl-form @submit.prevent="onSubmit">
    <dast-profiles-configurator
      ...
      class="gl-mb-6"
      :storage-key="$options.SECURITY_CONFIGURATION_CI_CD_STORAGE_KEY"
