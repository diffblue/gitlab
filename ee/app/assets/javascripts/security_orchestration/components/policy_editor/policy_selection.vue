<script>
import shieldCheckIllustration from '@gitlab/svgs/dist/illustrations/shield-check.svg?raw';
import magnifyingGlassIllustration from '@gitlab/svgs/dist/illustrations/magnifying-glass.svg?raw';
