...
RSpec.describe Groups::Security::ComplianceViolationReportsController, feature_category: :compliance_management do
  ...
  describe 'GET /groups/:group_id/-/security/compliance_violation_reports(.:format)' do
    subject(:request_export) { get group_security_compliance_violation_reports_path group, format: :csv }
