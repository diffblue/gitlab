...
RSpec.describe Gitlab::ContributionAnalytics::DataCollector do
  shared_examples 'contribution analytics data collector' do
    describe '#totals' do
  ...
  context 'when the flag :contribution_analytics_optimized_base_query is not enabled' do
    before do
      stub_feature_flags(contribution_analytics_optimized_base_query: false)
    end

    it_behaves_like 'contribution analytics data collector'
  end

  context 'when the flag :contribution_analytics_optimized_base_query is enabled' do
    before do
      stub_feature_flags(contribution_analytics_optimized_base_query: true)
    end
