  ...
  context 'with an authorized user with proper permissions' do
    ...
    context 'when deprecate_vulnerabilities_feedback is enabled' do
      ...
      context 'when there is an existing vulnerability for the finding' do
        ...
        context 'when dismissing vulnerability fails' do
          let(:create_service_double) { instance_double("::Vulnerabilities::DismissService", execute: service_failure_payload) }
          ...
          before do
            allow(::Vulnerabilities::DismissService).to receive(:new).and_return(create_service_double)
          end
      ...
      context 'when there is no vulnerability for the finding' do
        ...
        context 'when Vulnerability creation fails' do
          let(:create_service_double) { instance_double("::Vulnerabilities::CreateService", execute: service_failure_payload) }
          let(:service_failure_payload) do
            {
              status: :error,
              message: errors_double
