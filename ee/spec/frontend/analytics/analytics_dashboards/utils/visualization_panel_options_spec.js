...
describe('getPanelOptions', () => {
  it.each`
    ...
    ${'DataTable'}    | ${false}         | ${{}}
    ${'SingleStat'}   | ${false}         | ${{}}
    ${'LineChart'}    | ${false}         | ${{ xAxis: { name: __('Time'), type: 'time' }, yAxis: { name: __('Counts'), type: 'value' } }}
    ${'ColumnChart'}  | ${false}         | ${{ xAxis: { name: __('Dimension'), type: 'category' }, yAxis: { name: __('Counts'), type: 'value' } }}
    ${'ColumnChart'}  | ${true}          | ${{ xAxis: { name: __('Time'), type: 'time' }, yAxis: { name: __('Counts'), type: 'value' } }}
  `(
