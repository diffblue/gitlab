...
import ToolFilterDeprecated, {
  DROPDOWN_OPTIONS,
} from 'ee/security_dashboard/components/shared/filters/tool_filter_deprecated.vue';
...
describe('Tool Filter component (deprecated)', () => {
  let wrapper;

  const createWrapper = () => {
    wrapper = mountExtended(ToolFilterDeprecated, {
  ...
  describe('dropdown items', () => {
    it('shows all dropdown items with correct text', () => {
      ...
      expect(findDropdownItem(ALL_ID).text()).toBe(ToolFilterDeprecated.i18n.allItemsText);
