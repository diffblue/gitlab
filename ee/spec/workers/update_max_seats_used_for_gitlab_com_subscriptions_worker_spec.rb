...
RSpec.describe UpdateMaxSeatsUsedForGitlabComSubscriptionsWorker, :saas do
  describe '#perform' do
    ...
    let_it_be(:gitlab_subscription, refind: true) do
      create(:gitlab_subscription, namespace: create(:namespace, :with_namespace_settings), seats: 1)
    end

    let_it_be(:gitlab_subscription_2, refind: true) do
      create(:gitlab_subscription, namespace: create(:namespace, :with_namespace_settings), seats: 11)
    end
