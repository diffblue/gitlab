...
RSpec.describe GitlabSchema.types['GeoNode'], feature_category: :geo_replication do
  ...
  it 'has the expected fields' do
    expected_fields = %i[
      ...
      upload_registries job_artifact_registries ci_secure_file_registries container_repository_registries
      dependency_proxy_blob_registries dependency_proxy_manifest_registries
    ]
