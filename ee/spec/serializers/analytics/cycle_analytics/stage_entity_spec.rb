...
RSpec.describe Analytics::CycleAnalytics::StageEntity do
  ...
  context 'when label based event is given' do
    ...
    let(:stage) { build_stubbed(:cycle_analytics_group_stage, namespace: label.group, start_event_label: label, start_event_identifier: :merge_request_label_added, end_event_identifier: :merge_request_merged) }
