...
module QA
  RSpec.describe 'Create' do
    describe 'Approval rules' do
      ...
      it 'allows multiple approval rules with users and groups', quarantine: { issue: 'https://gitlab.com/gitlab-org/gitlab/-/issues/361342', type: :investigating, only: { pipeline: :nightly } }, testcase: 'https://gitlab.com/gitlab-org/gitlab/-/quality/test_cases/347771' do
