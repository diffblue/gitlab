...
the dashboard automatically aggregates DORA metrics and displays the current status of the value stream. Clicking on a particular DORA metric
brings you to the relevant chart within `Analytics > CI/CD`.
