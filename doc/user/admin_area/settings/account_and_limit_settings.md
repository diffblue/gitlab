...
[Project access tokens](../../project/settings/project_access_tokens.md) and [group access tokens](../../group/settings/group_access_tokens.md) also inherit this prefix.
