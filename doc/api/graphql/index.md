...
Max query size       | 10 000 characters per query. If this limit is reached make use of [variables](https://graphql.org/learn/queries/#variables), [fragments](https://graphql.org/learn/queries/#fragments) to reduce the query size. Remove white spaces as last resort.
