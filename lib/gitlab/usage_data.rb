      ...
      def system_usage_data
...

        {
          counts: {
            ...
            projects_with_terraform_reports: distinct_count(::Ci::JobArtifact.for_report(:terraform), :project_id),
            ...
            terraform_reports: count(::Ci::JobArtifact.for_report(:terraform)),
