...
module API
  class BackgroundMigrations < ::API::Base
    ...
    namespace 'databases/:database' do
      resources 'background_migrations' do
        desc 'Get the list of the background migrations'
        params do
    ...
    helpers do
      def present_entity(result)
        present result,
          with: ::API::Entities::BackgroundMigration
      end
    end
  end
end
